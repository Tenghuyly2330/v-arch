            ...
            <header>
                <div class="image-text">
                    ...
                    <div class="text header-text">
                        <span class="name uppercase">V-arch</span>
                    </div>
                </div>
            ...
            <div class="menu-bar">
                <div class="menu max-h-[80vh] overflow-y-auto scrollbar-hidden">
                    <ul class="manu-links">
                        ...
                        <li class="nav-link {{ Request::is('project_backend') ? 'bg-[#000] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('project_backend') }}">
                                <i class='bx bxl-vimeo icon'></i>
