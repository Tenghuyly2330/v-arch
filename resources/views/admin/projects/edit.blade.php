<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('project_backend.update', $project->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_en', $project->title_en) }}" type="text" name="title_en"
                    ...
                    <div>
                        ...
                        <textarea name="content_en" id="content_en" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_en', $project->content_en) }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_km', $project->title_km) }}" type="text" name="title_km"
                    ...
                    <div>
                        ...
                        <textarea name="content_km" id="content_km" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_km', $project->content_km) }}</textarea>
                        <x-input-error class="mt-2" :messages="$errors->get('content_km')" />
                    </div>
                </div>

                <div class="p-0 space-y-4">
                    <h1 class="text-[20px] font-[600] text-[#4FC9EE] uppercase">Chinese</h1>
                    <div>
                        <label for="title_ch" class="block text-sm font-medium text-gray-700">Title</label>
                        <input value="{{ old('title_ch', $project->title_ch) }}" type="text" name="title_ch"
                            id="title_ch" class="mt-1 block w-full p-2 border rounded-md text-black text-sm">
                    ...
                    <div>
                        ...
                        <textarea name="content_ch" id="content_ch" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_ch', $project->content_ch) }}</textarea>
            ...
            <div>
                <label for="dropzone-file{{ $project->id }}" id="drop-area"
                    ...
                    <input id="dropzone-file{{ $project->id }}" type="file" class="hidden" name="images[]"
                        accept="image/*" multiple onchange="uploadImages(project)" />
