<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('project_backend.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_ch') }}" type="text" name="title_ch" id="title_ch"
                            class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
                    ...
                    <div>
                        ...
                        <textarea name="content_ch" id="content_ch" rows="4"
                            class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">{{ old('content_ch') }}</textarea>
